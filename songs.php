            ...
            <div class="container">
                ...
                <div id="navbarMain" class="navbar-menu">
                    ...
                    <div class="navbar-end">
                        <div class="g-signin2" data-longtitle = "true" data-theme = "dark" data-width = "200" data-height = "50" data-onsuccess="onSignIn"></div>                        <p class="navbar-item has-text-weight-light karla"><a class="has-text-white" href='index.html' onclick="signOut()">Sign Out</a></p>
