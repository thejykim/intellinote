                            ...
                            <div class="card-content">
                                <div class="content">
                                    <div class = "columns">
                                        ...
                                        <div class = "column">
                                            <button class="button profileDelete is-danger is-small is-rounded" onclick = "toggleProfileDelete()">
                            ...
                            <div class="card-content">
                                <div class="content">
                                    <div class = "columns is-vcentered">
                                        ...
                                        <div class = "column">
                                            <button id = "' + songID + '" class="button profileDelete is-danger is-small is-rounded" onclick = "toggleProfileDelete()">
                                                <span id="deleteContent">
                                                    <span class="icon is-small">
                                                        <i class="fas fa-trash"></i>
                                                    </span>
